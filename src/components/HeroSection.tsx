    ...
    <section className="relative min-h-[85vh] md:min-h-[90vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container text-center px-4 py-12 md:py-20">
        <div className="flex items-center justify-center gap-1 mb-4">
          ...
          <span className="ml-2 text-xs md:text-sm font-semibold text-foreground">5.0 on Google</span>
        </div>

        <h1 className="font-heading text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-bold uppercase tracking-tight mb-4 text-foreground">
        ...
        <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center mb-6">
          <a
            ...
            className="inline-flex items-center justify-center gap-3 bg-primary text-primary-foreground font-heading text-base md:text-xl font-semibold uppercase px-6 md:px-8 py-4 rounded-lg animate-pulse-glow transition-transform hover:scale-105"
          >
