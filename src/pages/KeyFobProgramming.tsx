      ...
      <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container text-center px-4 py-20">
          <h1 className="font-heading text-4xl md:text-6xl font-bold uppercase tracking-tight mb-4">
            Key Fob <span className="text-primary">Programming</span> in Nairobi
          </h1>
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-8">
            Expert key fob and transponder programming for all car makes. Fast, mobile service at your location.
          </p>
          ...
          <p className="text-sm text-muted-foreground">
            <MapPin className="w-4 h-4 inline mr-1" /> Ngong Rd, Adam's Arcade • Mobile Service Across Nairobi
          </p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-card">
        <div className="container px-4">
          <h2 className="font-heading text-3xl md:text-4xl font-bold uppercase text-center mb-12">
            Our <span className="text-primary">Programming</span> Services
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div>
              <img src={smartKey} alt="Transponder key programming" className="rounded-lg w-full h-64 object-cover" loading="lazy" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-secondary">
        <div className="container px-4 text-center">
          <h2 className="font-heading text-3xl md:text-5xl font-bold uppercase mb-4">
            Key Fob Not <span className="text-primary">Working?</span>
          </h2>
          <p className="text-muted-foreground text-lg mb-8 max-w-xl mx-auto">
            We'll program or replace your key fob today. Call for instant help.
          </p>
