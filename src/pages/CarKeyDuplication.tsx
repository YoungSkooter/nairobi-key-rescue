      ...
      <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container text-center px-4 py-20">
          <h1 className="font-heading text-4xl md:text-6xl font-bold uppercase tracking-tight mb-4">
            Car Key <span className="text-primary">Duplication</span> in Nairobi
          </h1>
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-8">
            Need a spare car key? We duplicate all types of car keys fast and affordably — right where you are.
          </p>
      ...
      <section className="py-16 md:py-24 bg-card">
        <div className="container px-4">
          <h2 className="font-heading text-3xl md:text-4xl font-bold uppercase text-center mb-12">
            Why Choose Us for <span className="text-primary">Key Duplication</span>
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div>
              <img src={shellKey} alt="Car key duplication service" className="rounded-lg w-full h-64 object-cover" loading="lazy" />
            </div>
      ...
      <section className="py-16 md:py-24 bg-secondary">
        <div className="container px-4 text-center">
          <h2 className="font-heading text-3xl md:text-5xl font-bold uppercase mb-4">
            Get a <span className="text-primary">Spare Key</span> Today
          </h2>
          <p className="text-muted-foreground text-lg mb-8 max-w-xl mx-auto">
            Don't wait until you lose your only key. Get a duplicate made today — fast and affordable.
          </p>
