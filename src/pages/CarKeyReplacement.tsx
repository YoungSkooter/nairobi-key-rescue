import { Phone, MessageCircle, Key, CheckCircle, MapPin } from "lucide-react";
...
const benefits = [
  ...
  "Standard, flip, and smart keys",
  "Cut & programmed on the spot",
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden">
        <img src={duplication} alt="Car Key Replacement Nairobi" className="absolute inset-0 w-full h-full object-cover" loading="eager" />
        <div className="absolute inset-0 bg-gradient-to-b from-background/90 via-background/70 to-background/95" />
        <div className="relative z-10 container text-center px-4 py-20">
          <h1 className="font-heading text-4xl md:text-6xl font-bold uppercase tracking-tight mb-4">
            Car Key <span className="text-primary">Replacement</span> in Nairobi
          </h1>
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-8">
            Lost your car key? Need a spare? We replace all types of car keys on the spot — anywhere in Nairobi.
          </p>
      ...
      <section className="py-16 md:py-24 bg-card">
        <div className="container px-4">
          <h2 className="font-heading text-3xl md:text-4xl font-bold uppercase text-center mb-12">Why Choose Us for <span className="text-primary">Key Replacement</span></h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div><img src={smartKey} alt="Car key cutting service" className="rounded-lg w-full h-64 object-cover" loading="lazy" /></div>
      ...
      <section className="py-16 md:py-24 bg-secondary">
        <div className="container px-4 text-center">
          <h2 className="font-heading text-3xl md:text-5xl font-bold uppercase mb-4">Need a New <span className="text-primary">Car Key?</span></h2>
          <p className="text-muted-foreground text-lg mb-8 max-w-xl mx-auto">Call now for fast, same-day car key replacement anywhere in Nairobi.</p>
