      ...
      <section className="py-16 md:py-24 bg-card">
        <div className="container px-4">
          <h2 className="font-heading text-3xl md:text-4xl font-bold uppercase text-center mb-12">
            Why Choose Us for <span className="text-primary">Key Replacement</span>
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div>
              <img src={smartKey} alt="Car key cutting service" className="rounded-lg w-full h-64 object-cover" loading="lazy" />
            </div>
      ...
      <section className="py-16 md:py-24 bg-secondary">
        <div className="container px-4 text-center">
          <h2 className="font-heading text-3xl md:text-5xl font-bold uppercase mb-4">
            Need a New <span className="text-primary">Car Key?</span>
          </h2>
          <p className="text-muted-foreground text-lg mb-8 max-w-xl mx-auto">
            Call now for fast, same-day car key replacement anywhere in Nairobi.
          </p>
